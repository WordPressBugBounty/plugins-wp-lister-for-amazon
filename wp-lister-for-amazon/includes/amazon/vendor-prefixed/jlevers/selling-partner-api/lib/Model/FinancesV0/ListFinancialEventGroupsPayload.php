...
class ListFinancialEventGroupsPayload extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'next_token' => 'string',
        'financial_event_group_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FinancialEventGroup[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FinancialEventGroup[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FinancialEventGroup[]|null $financial_event_group_list A list of financial event group information.
     *
     * @return self
     */
