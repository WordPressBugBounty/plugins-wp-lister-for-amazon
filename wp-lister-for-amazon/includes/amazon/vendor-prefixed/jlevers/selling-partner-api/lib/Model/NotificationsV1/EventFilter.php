...
class EventFilter extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'aggregation_settings' => '\WPLab\Amazon\SellingPartnerApi\Model\NotificationsV1\AggregationSettings',
        'marketplace_ids' => 'string[]',
        'order_change_types' => '\WPLab\Amazon\SellingPartnerApi\Model\NotificationsV1\OrderChangeTypeEnum[]',
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\NotificationsV1\AggregationSettings|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\NotificationsV1\AggregationSettings|null $aggregation_settings aggregation_settings
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\NotificationsV1\OrderChangeTypeEnum[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\NotificationsV1\OrderChangeTypeEnum[]|null $order_change_types A list of order change types to subscribe to (e.g. BuyerRequestedChange). To receive notifications of all change types, do not provide this list.
     *
     * @return self
     */
