...
namespace WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801;
use ArrayAccess;
...
class Reason extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'reason_code' => 'string',
        'links' => '\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Link[]'
    ];
     ...
     * Gets links
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Link[]|null
     */
     ...
     * Sets links
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Link[]|null $links A list of path forward links that may allow Selling Partners to remove the restriction.
     *
     * @return self
     */
