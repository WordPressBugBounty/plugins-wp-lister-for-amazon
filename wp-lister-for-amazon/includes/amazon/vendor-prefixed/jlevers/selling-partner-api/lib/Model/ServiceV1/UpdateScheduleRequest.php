...
class UpdateScheduleRequest extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'schedules' => '\WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\AvailabilityRecord[]'
    ];
     ...
     * Gets schedules
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\AvailabilityRecord[]
     */
     ...
     * Sets schedules
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\AvailabilityRecord[] $schedules List of `AvailabilityRecord`s to represent the capacity of a resource over a time range.
     *
     * @return self
     */
