...
class LabelResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'tracking_id' => 'string',
        'label' => '\WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Label'
    ];
     ...
     * Gets label
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Label|null
     */
     ...
     * Sets label
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Label|null $label label
     *
     * @return self
     */
