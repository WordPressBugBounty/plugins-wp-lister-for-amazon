...
class InboundShipmentPlanRequestItem extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'seller_sku' => 'string',
        'asin' => 'string',
        'condition' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\Condition',
        'quantity' => 'int',
        'quantity_in_case' => 'int',
        'prep_details_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepDetails[]'
    ];
     ...
     * Gets condition
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\Condition
     */
     ...
     * Sets condition
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\Condition $condition condition
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepDetails[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepDetails[]|null $prep_details_list A list of preparation instructions and who is responsible for that preparation.
     *
     * @return self
     */
