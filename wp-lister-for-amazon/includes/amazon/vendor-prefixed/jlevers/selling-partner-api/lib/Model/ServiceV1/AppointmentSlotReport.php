...
class AppointmentSlotReport extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'start_time' => 'string',
        'end_time' => 'string',
        'appointment_slots' => '\WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\AppointmentSlot[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\AppointmentSlot[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\AppointmentSlot[]|null $appointment_slots A list of time windows along with associated capacity in which the service can be performed.
     *
     * @return self
     */
