...
class GetListingOffersBatchRequest extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'requests' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ListingOffersRequest[]'
    ];
     ...
     * Gets requests
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ListingOffersRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ListingOffersRequest[]|null $requests A list of `getListingOffers` batched requests to run.
     *
     * @return self
     */
