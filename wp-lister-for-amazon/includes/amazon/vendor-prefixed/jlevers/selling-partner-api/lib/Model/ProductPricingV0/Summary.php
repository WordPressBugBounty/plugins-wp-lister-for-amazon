...
namespace WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0;
use ArrayAccess;
...
class Summary extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'number_of_offers' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferCountType[]',
        'lowest_prices' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\LowestPriceType[]',
        'buy_box_prices' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\BuyBoxPriceType[]',
        'list_price' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType',
        'competitive_price_threshold' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType',
        'suggested_lower_price_plus_shipping' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType',
        'sales_rankings' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\SalesRankType[]',
        'buy_box_eligible_offers' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferCountType[]',
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferCountType[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferCountType[]|null $number_of_offers number_of_offers
     *
     * @return self
     */
     ...
     * Gets lowest_prices
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\LowestPriceType[]|null
     */
     ...
     * Sets lowest_prices
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\LowestPriceType[]|null $lowest_prices lowest_prices
     *
     * @return self
     */
     ...
     * Gets buy_box_prices
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\BuyBoxPriceType[]|null
     */
     ...
     * Sets buy_box_prices
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\BuyBoxPriceType[]|null $buy_box_prices buy_box_prices
     *
     * @return self
     */
     ...
     * Sets list_price
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType|null $list_price list_price
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType|null $competitive_price_threshold competitive_price_threshold
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType|null $suggested_lower_price_plus_shipping suggested_lower_price_plus_shipping
     *
     * @return self
     */
     ...
     * Gets sales_rankings
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\SalesRankType[]|null
     */
     ...
     * Sets sales_rankings
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\SalesRankType[]|null $sales_rankings A list of sales rank information for the item, by category.
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferCountType[]|null $buy_box_eligible_offers buy_box_eligible_offers
     *
     * @return self
     */
