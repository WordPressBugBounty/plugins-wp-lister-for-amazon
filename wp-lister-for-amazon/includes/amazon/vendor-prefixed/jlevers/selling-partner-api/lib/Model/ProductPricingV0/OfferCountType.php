...
class OfferCountType extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'condition' => 'string',
        'fulfillment_channel' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\FulfillmentChannelType',
        'offer_count' => 'int'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\FulfillmentChannelType|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\FulfillmentChannelType|null $fulfillment_channel fulfillment_channel
     *
     * @return self
     */
