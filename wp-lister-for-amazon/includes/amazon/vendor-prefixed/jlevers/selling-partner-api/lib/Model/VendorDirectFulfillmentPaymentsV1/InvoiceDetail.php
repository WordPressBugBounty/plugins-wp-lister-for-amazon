...
namespace WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1;
use ArrayAccess;
...
class InvoiceDetail extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'remit_to_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification',
        'ship_from_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification',
        'bill_to_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification',
        'ship_to_country_code' => 'string',
        'payment_terms_code' => 'string',
        'invoice_total' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\Money',
        'tax_totals' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\TaxDetail[]',
        'additional_details' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\AdditionalDetails[]',
        'charge_details' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\ChargeDetails[]',
        'items' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\InvoiceItem[]'
    ];
     ...
     * Gets remit_to_party
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification
     */
     ...
     * Sets remit_to_party
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification $remit_to_party remit_to_party
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification $ship_from_party ship_from_party
     *
     * @return self
     */
     ...
     * Gets bill_to_party
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification|null
     */
     ...
     * Sets bill_to_party
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\PartyIdentification|null $bill_to_party bill_to_party
     *
     * @return self
     */
     ...
     * Gets invoice_total
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\Money
     */
     ...
     * Sets invoice_total
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\Money $invoice_total invoice_total
     *
     * @return self
     */
     ...
     * Gets tax_totals
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\TaxDetail[]|null
     */
     ...
     * Sets tax_totals
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\TaxDetail[]|null $tax_totals Individual tax details per line item.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\AdditionalDetails[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\AdditionalDetails[]|null $additional_details Additional details provided by the selling party, for tax-related or other purposes.
     *
     * @return self
     */
     ...
     * Gets charge_details
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\ChargeDetails[]|null
     */
     ...
     * Sets charge_details
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\ChargeDetails[]|null $charge_details Total charge amount details for all line items.
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\InvoiceItem[]
     */
     ...
     * Sets items
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentPaymentsV1\InvoiceItem[] $items Provides the details of the items in this invoice.
     *
     * @return self
     */
