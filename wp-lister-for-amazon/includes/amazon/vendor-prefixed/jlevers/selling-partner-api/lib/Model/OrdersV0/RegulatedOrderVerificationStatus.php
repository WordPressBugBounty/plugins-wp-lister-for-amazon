...
class RegulatedOrderVerificationStatus extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'status' => '\WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\VerificationStatus',
        'requires_merchant_action' => 'bool',
        'valid_rejection_reasons' => '\WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\RejectionReason[]',
        'rejection_reason' => '\WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\RejectionReason',
        'review_date' => 'string',
     ...
     * Gets status
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\VerificationStatus
     */
     ...
     * Sets status
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\VerificationStatus $status status
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\RejectionReason[]
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\RejectionReason[] $valid_rejection_reasons A list of valid rejection reasons that may be used to reject the order's regulated information.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\RejectionReason|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\OrdersV0\RejectionReason|null $rejection_reason rejection_reason
     *
     * @return self
     */
