...
class ChargeComponent extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'charge_type' => 'string',
        'charge_amount' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\Currency'
    ];
     ...
     * Sets charge_amount
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\Currency|null $charge_amount charge_amount
     *
     * @return self
     */
