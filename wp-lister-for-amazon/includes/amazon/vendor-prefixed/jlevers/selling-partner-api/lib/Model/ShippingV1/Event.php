...
class Event extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'event_code' => 'string',
        'event_time' => 'string',
        'location' => '\WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Location'
    ];
     ...
     * Gets location
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Location|null
     */
     ...
     * Sets location
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Location|null $location location
     *
     * @return self
     */
