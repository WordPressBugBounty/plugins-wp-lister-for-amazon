...
class FailedAdhocDisbursementEventList extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'transfer_amount' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\Currency',
        'posted_date' => 'string'
    ];
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\Currency|null $transfer_amount transfer_amount
     *
     * @return self
     */
