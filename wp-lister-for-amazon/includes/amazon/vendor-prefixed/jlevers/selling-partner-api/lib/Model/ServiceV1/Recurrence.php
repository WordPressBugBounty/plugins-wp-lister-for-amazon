...
class Recurrence extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'end_time' => 'string',
        'days_of_week' => '\WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\DayOfWeek[]',
        'days_of_month' => 'int[]'
    ];
     ...
     * Gets days_of_week
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\DayOfWeek[]|null
     */
     ...
     * Sets days_of_week
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\DayOfWeek[]|null $days_of_week Days of the week when recurrence is valid. If the schedule is valid every Monday, input will only contain `MONDAY` in the list.
     *
     * @return self
     */
