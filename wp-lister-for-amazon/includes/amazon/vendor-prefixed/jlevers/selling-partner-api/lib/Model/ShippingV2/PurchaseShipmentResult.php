...
class PurchaseShipmentResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'package_document_details' => '\WPLab\Amazon\SellingPartnerApi\Model\ShippingV2\PackageDocumentDetail[]',
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ShippingV2\PackageDocumentDetail[]
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ShippingV2\PackageDocumentDetail[] $package_document_details A list of post-purchase details about a package that will be shipped using a shipping service.
     *
     * @return self
     */
