...
class NonPartneredSmallParcelDataOutput extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'package_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\NonPartneredSmallParcelPackageOutput[]'
    ];
     ...
     * Gets package_list
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\NonPartneredSmallParcelPackageOutput[]
     */
     ...
     * Sets package_list
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\NonPartneredSmallParcelPackageOutput[] $package_list A list of packages, including carrier, tracking number, and status information for each package.
     *
     * @return self
     */
