...
class GetPrepInstructionsResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'sku_prep_instructions_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\SKUPrepInstructions[]',
        'invalid_sku_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InvalidSKU[]',
        'asin_prep_instructions_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\ASINPrepInstructions[]',
        'invalid_asin_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InvalidASIN[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\SKUPrepInstructions[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\SKUPrepInstructions[]|null $sku_prep_instructions_list A list of SKU labeling requirements and item preparation instructions.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InvalidSKU[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InvalidSKU[]|null $invalid_sku_list A list of invalid SKU values and the reason they are invalid.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\ASINPrepInstructions[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\ASINPrepInstructions[]|null $asin_prep_instructions_list A list of item preparation instructions.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InvalidASIN[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InvalidASIN[]|null $invalid_asin_list A list of invalid ASIN values and the reasons they are invalid.
     *
     * @return self
     */
