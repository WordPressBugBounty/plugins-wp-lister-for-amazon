...
class FixedSlotCapacityQuery extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'capacity_types' => '\WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\CapacityType[]',
        'slot_duration' => 'float',
     ...
     * Sets capacity_types
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ServiceV1\CapacityType[]|null $capacity_types An array of capacity types which are being requested. Default value is `[SCHEDULED_CAPACITY]`.
     *
     * @return self
     */
