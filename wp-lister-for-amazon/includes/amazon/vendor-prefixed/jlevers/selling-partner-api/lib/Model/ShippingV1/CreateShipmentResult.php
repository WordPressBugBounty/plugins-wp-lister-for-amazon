...
class CreateShipmentResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'eligible_rates' => '\WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Rate[]'
    ];
     ...
     * Gets eligible_rates
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Rate[]
     */
     ...
     * Sets eligible_rates
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ShippingV1\Rate[] $eligible_rates A list of all the available rates that can be used to send the shipment.
     *
     * @return self
     */
