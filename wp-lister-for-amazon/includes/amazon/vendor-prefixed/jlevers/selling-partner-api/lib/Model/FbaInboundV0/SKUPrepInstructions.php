...
class SKUPrepInstructions extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'seller_sku' => 'string',
        'asin' => 'string',
        'barcode_instruction' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\BarcodeInstruction',
        'prep_guidance' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepGuidance',
        'prep_instruction_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepInstruction[]',
        'amazon_prep_fees_details_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\AmazonPrepFeesDetails[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\BarcodeInstruction|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\BarcodeInstruction|null $barcode_instruction barcode_instruction
     *
     * @return self
     */
     ...
     * Gets prep_guidance
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepGuidance|null
     */
     ...
     * Sets prep_guidance
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepGuidance|null $prep_guidance prep_guidance
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepInstruction[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\PrepInstruction[]|null $prep_instruction_list A list of preparation instructions to help with item sourcing decisions.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\AmazonPrepFeesDetails[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\AmazonPrepFeesDetails[]|null $amazon_prep_fees_details_list A list of preparation instructions and fees for Amazon to prep goods for shipment.
     *
     * @return self
     */
