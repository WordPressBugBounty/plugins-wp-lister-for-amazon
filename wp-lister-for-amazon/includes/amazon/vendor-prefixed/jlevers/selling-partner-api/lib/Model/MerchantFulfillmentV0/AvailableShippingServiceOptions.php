...
class AvailableShippingServiceOptions extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'available_carrier_will_pick_up_options' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AvailableCarrierWillPickUpOption[]',
        'available_delivery_experience_options' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AvailableDeliveryExperienceOption[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AvailableCarrierWillPickUpOption[]
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AvailableCarrierWillPickUpOption[] $available_carrier_will_pick_up_options List of available carrier pickup options.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AvailableDeliveryExperienceOption[]
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AvailableDeliveryExperienceOption[] $available_delivery_experience_options List of available delivery experience options.
     *
     * @return self
     */
