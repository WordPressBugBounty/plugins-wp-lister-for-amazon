...
class ShipmentEvent extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'order_charge_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ChargeComponent[]',
        'order_charge_adjustment_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ChargeComponent[]',
        'shipment_fee_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]',
        'shipment_fee_adjustment_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]',
        'order_fee_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]',
        'order_fee_adjustment_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]',
        'direct_payment_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\DirectPayment[]',
        'posted_date' => 'string',
        'shipment_item_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ShipmentItem[]',
        'shipment_item_adjustment_list' => '\WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ShipmentItem[]'
    ];
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ChargeComponent[]|null $order_charge_list A list of charge information on the seller's account.
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ChargeComponent[]|null $order_charge_adjustment_list A list of charge information on the seller's account.
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]|null $shipment_fee_list A list of fee component information.
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]|null $shipment_fee_adjustment_list A list of fee component information.
     *
     * @return self
     */
     ...
     * Sets order_fee_list
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]|null $order_fee_list A list of fee component information.
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\FeeComponent[]|null $order_fee_adjustment_list A list of fee component information.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\DirectPayment[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\DirectPayment[]|null $direct_payment_list A list of direct payment information.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ShipmentItem[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ShipmentItem[]|null $shipment_item_list A list of shipment items.
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FinancesV0\ShipmentItem[]|null $shipment_item_adjustment_list A list of shipment items.
     *
     * @return self
     */
