...
namespace WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1;
use ArrayAccess;
...
class OrderDetails extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'order_date' => 'string',
        'order_status' => 'string',
        'shipment_details' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\ShipmentDetails',
        'tax_total' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\OrderDetailsTaxTotal',
        'selling_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification',
        'ship_from_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification',
        'ship_to_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\Address',
        'bill_to_party' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification',
        'items' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\OrderItem[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\ShipmentDetails
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\ShipmentDetails $shipment_details shipment_details
     *
     * @return self
     */
     ...
     * Gets tax_total
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\OrderDetailsTaxTotal|null
     */
     ...
     * Sets tax_total
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\OrderDetailsTaxTotal|null $tax_total tax_total
     *
     * @return self
     */
     ...
     * Gets selling_party
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification
     */
     ...
     * Sets selling_party
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification $selling_party selling_party
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification $ship_from_party ship_from_party
     *
     * @return self
     */
     ...
     * Gets ship_to_party
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\Address
     */
     ...
     * Sets ship_to_party
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\Address $ship_to_party ship_to_party
     *
     * @return self
     */
     ...
     * Sets bill_to_party
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\PartyIdentification $bill_to_party bill_to_party
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\OrderItem[]
     */
     ...
     * Sets items
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentOrdersV1\OrderItem[] $items A list of items in this purchase order.
     *
     * @return self
     */
