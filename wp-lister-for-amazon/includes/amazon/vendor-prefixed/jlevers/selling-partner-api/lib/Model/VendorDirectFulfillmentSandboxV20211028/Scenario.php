...
class Scenario extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'scenario_id' => 'string',
        'orders' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentSandboxV20211028\TestOrder[]'
    ];
     ...
     * Gets orders
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentSandboxV20211028\TestOrder[]
     */
     ...
     * Sets orders
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentSandboxV20211028\TestOrder[] $orders A list of orders that can be used by the caller to test each life cycle or scenario.
     *
     * @return self
     */
