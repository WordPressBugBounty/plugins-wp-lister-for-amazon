...
class GetListingOffersBatchResponse extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'responses' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ListingOffersResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ListingOffersResponse[]|null
     */
     ...
     * Sets responses
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ListingOffersResponse[]|null $responses A list of `getListingOffers` batched responses.
     *
     * @return self
     */
