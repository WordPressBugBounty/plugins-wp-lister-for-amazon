...
class PurchaseOrders extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'ship_window' => 'string',
        'items' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorShippingV1\PurchaseOrderItems[]'
    ];
     ...
     * Gets items
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorShippingV1\PurchaseOrderItems[]|null
     */
     ...
     * Sets items
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorShippingV1\PurchaseOrderItems[]|null $items A list of the items that are associated to the PO in this transport and their associated details.
     *
     * @return self
     */
