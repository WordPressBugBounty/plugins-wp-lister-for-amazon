...
class GetShipmentItemsResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'item_data' => '\WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InboundShipmentItem[]',
        'next_token' => 'string'
    ];
     ...
     * Gets item_data
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InboundShipmentItem[]|null
     */
     ...
     * Sets item_data
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\FbaInboundV0\InboundShipmentItem[]|null $item_data A list of inbound shipment item information.
     *
     * @return self
     */
