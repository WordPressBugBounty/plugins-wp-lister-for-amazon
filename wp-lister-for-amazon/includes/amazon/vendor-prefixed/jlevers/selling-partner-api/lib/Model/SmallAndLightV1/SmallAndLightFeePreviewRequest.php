...
class SmallAndLightFeePreviewRequest extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\WPLab\Amazon\SellingPartnerApi\Model\SmallAndLightV1\Item[]'
    ];
     ...
     * Gets items
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\SmallAndLightV1\Item[]
     */
     ...
     * Sets items
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\SmallAndLightV1\Item[] $items A list of items for which to retrieve fee estimates (limit: 25).
     *
     * @return self
     */
