...
class TestCaseData extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'scenarios' => '\WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentSandboxV20211028\Scenario[]'
    ];
     ...
     * Gets scenarios
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentSandboxV20211028\Scenario[]|null
     */
     ...
     * Sets scenarios
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\VendorDirectFulfillmentSandboxV20211028\Scenario[]|null $scenarios Set of use cases that describes the possible test scenarios.
     *
     * @return self
     */
