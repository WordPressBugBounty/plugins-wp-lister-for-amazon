...
class DirectPurchaseResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'package_document_detail_list' => '\WPLab\Amazon\SellingPartnerApi\Model\ShippingV2\PackageDocumentDetail[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ShippingV2\PackageDocumentDetail[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ShippingV2\PackageDocumentDetail[]|null $package_document_detail_list A list of post-purchase details about a package that will be shipped using a shipping service.
     *
     * @return self
     */
