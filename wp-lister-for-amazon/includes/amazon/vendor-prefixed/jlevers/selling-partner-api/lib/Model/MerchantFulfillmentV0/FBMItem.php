...
class FBMItem extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'int',
        'item_weight' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\Weight',
        'item_description' => 'string',
        'transparency_code_list' => 'string[]',
        'item_level_seller_inputs_list' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AdditionalSellerInputs[]'
    ];
     ...
     * Sets item_weight
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\Weight|null $item_weight item_weight
     *
     * @return self
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AdditionalSellerInputs[]|null $item_level_seller_inputs_list A list of additional seller input pairs required to purchase shipping.
     *
     * @return self
     */
