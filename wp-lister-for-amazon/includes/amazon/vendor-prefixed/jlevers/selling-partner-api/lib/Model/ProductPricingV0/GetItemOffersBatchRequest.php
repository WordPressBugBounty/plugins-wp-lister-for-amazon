...
class GetItemOffersBatchRequest extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'requests' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ItemOffersRequest[]'
    ];
     ...
     * Gets requests
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ItemOffersRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\ItemOffersRequest[]|null $requests A list of `getListingOffers` batched requests to run.
     *
     * @return self
     */
