...
class CreateShipmentRequest extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'shipment_request_details' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\ShipmentRequestDetails',
        'shipping_service_id' => 'string',
        'shipping_service_offer_id' => 'string',
        'hazmat_type' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\HazmatType',
        'label_format_option' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\LabelFormatOptionRequest',
        'shipment_level_seller_inputs_list' => '\WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AdditionalSellerInputs[]'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\ShipmentRequestDetails
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\ShipmentRequestDetails $shipment_request_details shipment_request_details
     *
     * @return self
     */
     ...
     * Gets hazmat_type
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\HazmatType|null
     */
     ...
     * Sets hazmat_type
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\HazmatType|null $hazmat_type hazmat_type
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\LabelFormatOptionRequest|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\LabelFormatOptionRequest|null $label_format_option label_format_option
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AdditionalSellerInputs[]|null
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\MerchantFulfillmentV0\AdditionalSellerInputs[]|null $shipment_level_seller_inputs_list A list of additional seller input pairs required to purchase shipping.
     *
     * @return self
     */
