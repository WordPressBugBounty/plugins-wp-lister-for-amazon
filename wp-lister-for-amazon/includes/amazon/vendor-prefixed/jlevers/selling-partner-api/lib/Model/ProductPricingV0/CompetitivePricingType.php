...
class CompetitivePricingType extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'competitive_prices' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\CompetitivePriceType[]',
        'number_of_offer_listings' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferListingCountType[]',
        'trade_in_value' => '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType'
    ];
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\CompetitivePriceType[]
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\CompetitivePriceType[] $competitive_prices A list of competitive pricing information.
     *
     * @return self
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferListingCountType[]
     */
     ...
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\OfferListingCountType[] $number_of_offer_listings The number of active offer listings for the item that was submitted. The listing count is returned by condition, one for each listing condition value that is returned.
     *
     * @return self
     */
     ...
     * Sets trade_in_value
     *
     * @param \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\MoneyType|null $trade_in_value trade_in_value
     *
     * @return self
     */
