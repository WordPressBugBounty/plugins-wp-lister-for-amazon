...
use WPLab\Amazon\GuzzleHttp\Exception\ClientException;
...
use WPLab\Amazon\SellingPartnerApi\Contract\AuthorizationSignerContract;
use WPLab\Amazon\SellingPartnerApi\Contract\RequestSignerContract;
...
class Authentication implements RequestSignerContract
{
    ...
    public function requestLWAToken(): array
    {
        ...
        $lwaTokenRequestBody = \WPLab\Amazon\GuzzleHttp\json_encode($jsonData);
    ...
    public function signRequest(
        ...
        if (
            ...
            if ($operation === 'getReportDocument') {
                ...
                $constantPath = isset($params['reportType']) ? 'WPLab\Amazon\SellingPartnerApi\ReportType::' . $params['reportType'] : null;
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Credentials The grantless credentials
     */
     ...
     *
     * @return \WPLab\Amazon\SellingPartnerApi\Credentials A set of STS credentials
     */
     ...
     *
     * @param ?\WPLab\Amazon\SellingPartnerApi\Credentials $creds The credentials to check
