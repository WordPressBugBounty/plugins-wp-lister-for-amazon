...
class ProductPricingV0Api extends BaseApi
{
     ...
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetPricingResponse
     */
    ...
    public function getCompetitivePricingWithHttpInfo($marketplace_id, $item_type, $asins = null, $skus = null, $customer_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetPricingResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetPricingResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetPricingResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetPricingResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetPricingResponse',
     ...
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetOffersResponse
     */
    ...
    public function getItemOffersWithHttpInfo($marketplace_id, $item_condition, $asin, $customer_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetOffersResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetOffersResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetOffersResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetOffersResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetOffersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchRequest $get_item_offers_batch_request_body get_item_offers_batch_request_body (required)
     *
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchResponse
     */
     ...
     *
     * @param  \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchRequest $get_item_offers_batch_request_body (required)
     *
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getItemOffersBatchWithHttpInfo($get_item_offers_batch_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\Errors' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\Errors', $response->getHeaders());
                case 401:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\Errors' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetItemOffersBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\Errors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getItemOffersBatchRequest($get_item_offers_batch_request_body)
    {
        ...
        if (isset($get_item_offers_batch_request_body)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \WPLab\Amazon\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($get_item_offers_batch_request_body));
            } else {
     ...
     *
     * @param  \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchRequest $get_listing_offers_batch_request_body get_listing_offers_batch_request_body (required)
     *
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchResponse
     */
     ...
     *
     * @param  \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchRequest $get_listing_offers_batch_request_body (required)
     *
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getListingOffersBatchWithHttpInfo($get_listing_offers_batch_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\Errors' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV0\GetListingOffersBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getListingOffersBatchRequest($get_listing_offers_batch_request_body)
    {
        ...
        if (isset($get_listing_offers_batch_request_body)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \WPLab\Amazon\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($get_listing_offers_batch_request_body));
            } else {
