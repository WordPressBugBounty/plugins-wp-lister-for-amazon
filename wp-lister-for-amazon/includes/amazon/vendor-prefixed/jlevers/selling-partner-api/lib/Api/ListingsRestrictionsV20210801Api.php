...
class ListingsRestrictionsV20210801Api extends BaseApi
{
     ...
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\RestrictionList
     */
    ...
    public function getListingsRestrictionsWithHttpInfo($asin, $seller_id, $marketplace_ids, $condition_type = null, $reason_locale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\RestrictionList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\RestrictionList', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Error[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Error[]', $response->getHeaders());
                case 403:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Error[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\RestrictionList';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\RestrictionList',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ListingsRestrictionsV20210801\Error[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
