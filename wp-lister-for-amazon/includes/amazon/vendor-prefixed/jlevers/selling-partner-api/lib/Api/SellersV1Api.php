...
class SellersV1Api extends BaseApi
{
     ...
     * @return \WPLab\Amazon\SellingPartnerApi\Model\SellersV1\GetMarketplaceParticipationsResponse
     */
    ...
    public function getMarketplaceParticipationsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\SellersV1\GetMarketplaceParticipationsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\SellersV1\GetMarketplaceParticipationsResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\SellersV1\GetMarketplaceParticipationsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\SellersV1\GetMarketplaceParticipationsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\SellersV1\GetMarketplaceParticipationsResponse',
