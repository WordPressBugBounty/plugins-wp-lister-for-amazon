...
class UploadsV20201101Api extends BaseApi
{
     ...
     * @return \WPLab\Amazon\SellingPartnerApi\Model\UploadsV20201101\CreateUploadDestinationResponse
     */
    ...
    public function createUploadDestinationForResourceWithHttpInfo($marketplace_ids, $content_md5, $resource, $content_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\UploadsV20201101\CreateUploadDestinationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\UploadsV20201101\CreateUploadDestinationResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\UploadsV20201101\CreateUploadDestinationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\UploadsV20201101\CreateUploadDestinationResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\UploadsV20201101\CreateUploadDestinationResponse',
