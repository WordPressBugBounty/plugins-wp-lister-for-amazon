...
class ProductPricingV20220501Api extends BaseApi
{
     ...
     *
     * @param  \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchRequest $get_featured_offer_expected_price_batch_request_body get_featured_offer_expected_price_batch_request_body (required)
     *
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchResponse
     */
     ...
     *
     * @param  \WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchRequest $get_featured_offer_expected_price_batch_request_body (required)
     *
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getFeaturedOfferExpectedPriceBatchWithHttpInfo($get_featured_offer_expected_price_batch_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\Errors' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\Errors', $response->getHeaders());
                case 401:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\Errors' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\GetFeaturedOfferExpectedPriceBatchResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\ProductPricingV20220501\Errors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getFeaturedOfferExpectedPriceBatchRequest($get_featured_offer_expected_price_batch_request_body)
    {
        ...
        if (isset($get_featured_offer_expected_price_batch_request_body)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \WPLab\Amazon\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($get_featured_offer_expected_price_batch_request_body));
            } else {
