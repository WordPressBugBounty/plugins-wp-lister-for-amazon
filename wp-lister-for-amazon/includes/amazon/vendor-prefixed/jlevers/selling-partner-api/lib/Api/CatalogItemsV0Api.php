...
class CatalogItemsV0Api extends BaseApi
{
     ...
     * @return \WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\GetCatalogItemResponse
     */
    ...
    public function getCatalogItemWithHttpInfo($marketplace_id, $asin)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\GetCatalogItemResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\GetCatalogItemResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\GetCatalogItemResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\GetCatalogItemResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\GetCatalogItemResponse',
     ...
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogCategoriesResponse
     */
    ...
    public function listCatalogCategoriesWithHttpInfo($marketplace_id, $asin = null, $seller_sku = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogCategoriesResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogCategoriesResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogCategoriesResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogCategoriesResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogCategoriesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WPLab\Amazon\SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogItemsResponse
     */
    ...
    public function listCatalogItemsWithHttpInfo($marketplace_id, $query = null, $query_context_id = null, $seller_sku = null, $upc = null, $ean = null, $isbn = null, $jan = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogItemsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogItemsResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogItemsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogItemsResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\CatalogItemsV0\ListCatalogItemsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
