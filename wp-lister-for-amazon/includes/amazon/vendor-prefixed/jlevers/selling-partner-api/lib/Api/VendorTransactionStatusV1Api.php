...
class VendorTransactionStatusV1Api extends BaseApi
{
     ...
     * @return \WPLab\Amazon\SellingPartnerApi\Model\VendorTransactionStatusV1\GetTransactionResponse
     */
    ...
    public function getTransactionWithHttpInfo($transaction_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\VendorTransactionStatusV1\GetTransactionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\WPLab\Amazon\SellingPartnerApi\Model\VendorTransactionStatusV1\GetTransactionResponse', $response->getHeaders());
                case 400:
                    if ('\WPLab\Amazon\SellingPartnerApi\Model\VendorTransactionStatusV1\GetTransactionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\WPLab\Amazon\SellingPartnerApi\Model\VendorTransactionStatusV1\GetTransactionResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPLab\Amazon\SellingPartnerApi\Model\VendorTransactionStatusV1\GetTransactionResponse',
