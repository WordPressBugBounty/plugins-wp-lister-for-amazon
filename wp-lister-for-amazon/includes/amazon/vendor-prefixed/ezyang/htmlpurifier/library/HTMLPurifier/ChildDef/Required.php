 ...
 */
class WPLab_Amazon_HTMLPurifier_ChildDef_Required extends WPLab_Amazon_HTMLPurifier_ChildDef
{
    /**
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        while (!empty($stack)) {
            ...
            if (!isset($this->elements[$node->name])) {
                ...
                if ($pcdata_allowed && $node instanceof WPLab_Amazon_HTMLPurifier_Node_Text) {
                    $result[] = $node;
                    continue;
                }
