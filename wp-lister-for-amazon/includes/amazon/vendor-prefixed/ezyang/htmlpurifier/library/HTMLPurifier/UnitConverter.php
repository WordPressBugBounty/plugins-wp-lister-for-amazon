 ...
 */
class WPLab_Amazon_HTMLPurifier_UnitConverter
{
     ...
     * @param WPLab_Amazon_HTMLPurifier_Length $length
     *      Instance of WPLab_Amazon_HTMLPurifier_Length to convert. You must validate()
     *      it before passing it here!
     * @param string $to_unit
     *      Unit to convert to.
     * @return WPLab_Amazon_HTMLPurifier_Length|bool
     * @note
    ...
    public function convert($length, $to_unit)
    {
        ...
        if ($n === '0' || $unit === false) {
            return new WPLab_Amazon_HTMLPurifier_Length('0', false);
        }
