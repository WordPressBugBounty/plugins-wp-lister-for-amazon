 ...
 */
class WPLab_Amazon_HTMLPurifier_HTMLDefinition extends WPLab_Amazon_HTMLPurifier_Definition
{

    // FULLY-PUBLIC VARIABLES ---------------------------------------------

    /**
     * Associative array of element names to WPLab_Amazon_HTMLPurifier_ElementDef.
     * @type WPLab_Amazon_HTMLPurifier_ElementDef[]
     */
    public $info = array();
    ...
    /**
     * Associative array of deprecated tag name to WPLab_Amazon_HTMLPurifier_TagTransform.
     * @type array
     */
    public $info_tag_transform = array();

    /**
     * Indexed list of WPLab_Amazon_HTMLPurifier_AttrTransform to be performed before validation.
     * @type WPLab_Amazon_HTMLPurifier_AttrTransform[]
     */
    public $info_attr_transform_pre = array();

    /**
     * Indexed list of WPLab_Amazon_HTMLPurifier_AttrTransform to be performed after validation.
     * @type WPLab_Amazon_HTMLPurifier_AttrTransform[]
     */
    ...
    /**
     * Indexed list of WPLab_Amazon_HTMLPurifier_Injector to be used.
    ...
    /**
     * Doctype object
     * @type WPLab_Amazon_HTMLPurifier_Doctype
     */
    public $doctype;
     ...
     *       method in WPLab_Amazon_HTMLPurifier_HTMLModule
     ...
     *             WPLab_Amazon_HTMLPurifier_AttrTypes for details
     */
     ...
     * @see WPLab_Amazon_HTMLPurifier_HTMLModule::addElement() for detailed
     ...
     * @return WPLab_Amazon_HTMLPurifier_ElementDef
     * @see WPLab_Amazon_HTMLPurifier_HTMLModule::addBlankElement() for detailed
     *       parameter and return value descriptions.
     */
     ...
     * module.
     * @return WPLab_Amazon_HTMLPurifier_HTMLModule
     */
    public function getAnonymousModule()
    {
        if (!$this->_anonModule) {
            $this->_anonModule = new WPLab_Amazon_HTMLPurifier_HTMLModule();
    ...
    /**
     * @type WPLab_Amazon_HTMLPurifier_HTMLModuleManager
     */
    public $manager;
    ...
    {
        $this->manager = new WPLab_Amazon_HTMLPurifier_HTMLModuleManager();
    }
