 ...
 */
class WPLab_Amazon_HTMLPurifier_AttrDef_URI_Host extends WPLab_Amazon_HTMLPurifier_AttrDef
{

    /**
     * IPv4 sub-validator.
     * @type WPLab_Amazon_HTMLPurifier_AttrDef_URI_IPv4
     */
    protected $ipv4;

    /**
     * IPv6 sub-validator.
     * @type WPLab_Amazon_HTMLPurifier_AttrDef_URI_IPv6
     */
    protected $ipv6;

    public function __construct()
    {
        $this->ipv4 = new WPLab_Amazon_HTMLPurifier_AttrDef_URI_IPv4();
        $this->ipv6 = new WPLab_Amazon_HTMLPurifier_AttrDef_URI_IPv6();
    }
