 ...
 */
class WPLab_Amazon_HTMLPurifier_HTMLModule_Forms extends WPLab_Amazon_HTMLPurifier_HTMLModule
{
    /**
     * @type string
     */
    ...
    public function setup($config)
    {
        ...
        $input->attr_transform_post[] = new WPLab_Amazon_HTMLPurifier_AttrTransform_Input();
        ...
        $textarea->attr_transform_pre[] = new WPLab_Amazon_HTMLPurifier_AttrTransform_Textarea();
