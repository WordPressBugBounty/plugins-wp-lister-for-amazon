 ...
 */
class WPLab_Amazon_HTMLPurifier_Injector_SafeObject extends WPLab_Amazon_HTMLPurifier_Injector
{
    /**
     * @type string
     */
    ...
    public function handleElement(&$token)
    {
        if ($token->name == 'object') {
            ...
            foreach ($this->addParam as $name => $value) {
                $new[] = new WPLab_Amazon_HTMLPurifier_Token_Empty('param', array('name' => $name, 'value' => $value));
            }
            $token = $new;
