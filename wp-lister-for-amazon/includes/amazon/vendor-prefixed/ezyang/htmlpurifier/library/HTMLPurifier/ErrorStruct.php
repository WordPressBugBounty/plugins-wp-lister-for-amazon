 ...
 */
class WPLab_Amazon_HTMLPurifier_ErrorStruct
{
     ...
     * values for this:
     *  - TOKEN: Instance of WPLab_Amazon_HTMLPurifier_Token
    ...
    public function getChild($type, $id)
    {
        if (!isset($this->children[$type][$id])) {
            $this->children[$type][$id] = new WPLab_Amazon_HTMLPurifier_ErrorStruct();
