 ...
 */
class WPLab_Amazon_HTMLPurifier_AttrValidator
{

    /**
     * Validates the attributes of a token, mutating it as necessary.
     * that has valid tokens
     * @param WPLab_Amazon_HTMLPurifier_Token $token Token to validate.
    ...
    public function validateToken($token, $config, $context)
    {
        ...
        if (!$token instanceof WPLab_Amazon_HTMLPurifier_Token_Start &&
            !$token instanceof WPLab_Amazon_HTMLPurifier_Token_Empty
        ) {
            return;
        }
