...
class WPLab_Amazon_HTMLPurifier_Strategy_FixNesting extends WPLab_Amazon_HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // refer to substrings
        $top_node = WPLab_Amazon_HTMLPurifier_Arborize::arborize($tokens, $config, $context);
        ...
        while (!empty($stack)) {
            ...
            while (isset($node->children[$ix])) {
                ...
                if ($child instanceof WPLab_Amazon_HTMLPurifier_Node_Element) {
                    $go = true;
        ...
        return WPLab_Amazon_HTMLPurifier_Arborize::flatten($node, $config, $context);
    }
}
