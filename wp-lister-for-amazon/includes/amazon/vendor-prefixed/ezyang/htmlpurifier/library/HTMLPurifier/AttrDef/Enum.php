 ...
 */
class WPLab_Amazon_HTMLPurifier_AttrDef_Enum extends WPLab_Amazon_HTMLPurifier_AttrDef
{
     ...
     *      case sensitive
     * @return WPLab_Amazon_HTMLPurifier_AttrDef_Enum
     */
    public function make($string)
    {
        ...
        return new WPLab_Amazon_HTMLPurifier_AttrDef_Enum($values, $sensitive);
    }
}
