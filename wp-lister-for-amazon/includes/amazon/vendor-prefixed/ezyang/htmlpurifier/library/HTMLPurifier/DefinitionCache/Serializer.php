...
class WPLab_Amazon_HTMLPurifier_DefinitionCache_Serializer extends WPLab_Amazon_HTMLPurifier_DefinitionCache
{
    ...
    /**
     * @param WPLab_Amazon_HTMLPurifier_Config $config
     * @return bool|WPLab_Amazon_HTMLPurifier_Config
     */
    ...
    public function generateBaseDirectoryPath($config)
    {
        ...
        $base = is_null($base) ? HTMLPURIFIER_PREFIX . '/WPLab_Amazon_HTMLPurifier/DefinitionCache/Serializer' : $base;
        return $base;
    }
