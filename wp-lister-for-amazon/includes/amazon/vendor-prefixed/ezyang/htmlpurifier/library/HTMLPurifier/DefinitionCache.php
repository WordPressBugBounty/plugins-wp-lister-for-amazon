 ...
 */
abstract class WPLab_Amazon_HTMLPurifier_DefinitionCache
{
    /**
     * @type string
     */
     ...
     * @param WPLab_Amazon_HTMLPurifier_Config $config Instance of WPLab_Amazon_HTMLPurifier_Config to test against
     * @return bool
     */
     ...
     * @param WPLab_Amazon_HTMLPurifier_Definition $def Definition object to check
