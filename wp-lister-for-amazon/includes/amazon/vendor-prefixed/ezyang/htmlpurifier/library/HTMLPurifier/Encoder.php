 ...
 */
class WPLab_Amazon_HTMLPurifier_Encoder
{
    ...
    {
        set_error_handler(array('WPLab_Amazon_HTMLPurifier_Encoder', 'muteErrorHandler'));
        $r = iconv($in, $out, $text);
     ...
     * Arguably this function should be modernized to the WPLab_Amazon_HTML5 set
    ...
    public static function convertToUTF8($str, $config, $context)
    {
        ...
        $bug = WPLab_Amazon_HTMLPurifier_Encoder::testIconvTruncateBug();
