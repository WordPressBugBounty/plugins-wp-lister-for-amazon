...
class WPLab_Amazon_HTMLPurifier_DoctypeRegistry
{
     ...
     * @return WPLab_Amazon_HTMLPurifier_Doctype Editable registered doctype
     */
    public function register(
        ...
        if (!is_object($doctype)) {
            $doctype = new WPLab_Amazon_HTMLPurifier_Doctype(
                $doctype,
                $xml,
                $modules,
                $tidy_modules,
     ...
     * @return WPLab_Amazon_HTMLPurifier_Doctype Editable doctype object
     */
    public function get($doctype)
    {
        ...
        if (!isset($this->doctypes[$doctype])) {
            ...
            $anon = new WPLab_Amazon_HTMLPurifier_Doctype($doctype);
            return $anon;
        }
     ...
     * @return WPLab_Amazon_HTMLPurifier_Doctype
     */
