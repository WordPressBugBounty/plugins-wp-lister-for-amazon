...
class WPLab_Amazon_HTMLPurifier_EntityParser
{
     ...
     * @type WPLab_Amazon_HTMLPurifier_EntityLookup
     */
    ...
    protected function entityCallback($matches)
    {
        ...
        if ($hex_part !== NULL && $hex_part !== "") {
            ...
            return WPLab_Amazon_HTMLPurifier_Encoder::unichr((int) $dec_part);
        } else {
            if (!$this->_entity_lookup) {
                $this->_entity_lookup = WPLab_Amazon_HTMLPurifier_EntityLookup::instance();
            }
    ...
    protected function nonSpecialEntityCallback($matches)
    {
        ...
        if ($is_num) {
            ...
            return WPLab_Amazon_HTMLPurifier_Encoder::unichr($code);
        } else {
