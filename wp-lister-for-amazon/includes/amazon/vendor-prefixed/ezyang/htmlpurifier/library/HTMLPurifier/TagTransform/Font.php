 ...
 */
class WPLab_Amazon_HTMLPurifier_TagTransform_Font extends WPLab_Amazon_HTMLPurifier_TagTransform
{
    /**
     * @type string
     */
     ...
     * @return WPLab_Amazon_HTMLPurifier_Token_End|string
     */
    public function transform($tag, $config, $context)
    {
        if ($tag instanceof WPLab_Amazon_HTMLPurifier_Token_End) {
            $new_tag = clone $tag;
