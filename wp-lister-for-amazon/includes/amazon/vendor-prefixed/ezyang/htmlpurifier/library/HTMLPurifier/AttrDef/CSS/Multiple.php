 ...
 */
class WPLab_Amazon_HTMLPurifier_AttrDef_CSS_Multiple extends WPLab_Amazon_HTMLPurifier_AttrDef
{
    /**
    ...
    /**
     * @param WPLab_Amazon_HTMLPurifier_AttrDef $single WPLab_Amazon_HTMLPurifier_AttrDef to multiply
