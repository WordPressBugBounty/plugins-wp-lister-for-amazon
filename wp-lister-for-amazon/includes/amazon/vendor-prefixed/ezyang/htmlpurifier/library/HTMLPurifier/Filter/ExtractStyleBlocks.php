 ...
 *
 * @note
 *      See tests/WPLab_Amazon_HTMLPurifier/Filter/ExtractStyleBlocksTest.php for
 *      sample usage.
 *
 * @note
...
class WPLab_Amazon_HTMLPurifier_Filter_ExtractStyleBlocks extends WPLab_Amazon_HTMLPurifier_Filter
{
    ...
    /**
     * @type WPLab_Amazon_HTMLPurifier_AttrDef_CSS_Ident
     */
    ...
    public function __construct()
    {
        ...
        $this->_id_attrdef = new WPLab_Amazon_HTMLPurifier_AttrDef_HTML_ID(true);
        $this->_class_attrdef = new WPLab_Amazon_HTMLPurifier_AttrDef_CSS_Ident();
        $this->_enum_attrdef = new WPLab_Amazon_HTMLPurifier_AttrDef_Enum(
            array(
                'first-child',
                'link',
                'visited',
                                ...
                                for ($j = 0, $cc = count($components); $j < $cc; $j++) {
                                    ...
                                    if ($j === 0) {
                                        ...
                                        if ($sdelim === '#') {
                                            ...
                                            throw new WPLab_Amazon_HTMLPurifier_Exception('broken invariant sdelim and preg_split');
                                        }
