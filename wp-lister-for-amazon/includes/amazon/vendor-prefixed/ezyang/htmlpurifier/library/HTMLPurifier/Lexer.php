 ...
 * WPLab_Amazon_HTMLPurifier_Lexer_DOMLex).  There are several implementations to choose
 * from.
 *
...
class WPLab_Amazon_HTMLPurifier_Lexer
{
    ...
    /**
     * @type WPLab_Amazon_HTMLPurifier_EntityParser
     */
     ...
     *
     * By default WPLab_Amazon_HTMLPurifier_Lexer_DOMLex will be returned. There are
     ...
     * @return WPLab_Amazon_HTMLPurifier_Lexer
    ...
    public static function create($config)
    {
        if (!($config instanceof WPLab_Amazon_HTMLPurifier_Config)) {
            ...
            trigger_error(
                ...
                WPLab_Amazon_HTMLPurifier_Lexer::create() is deprecated, please instead
                use %Core.LexerImpl",
                E_USER_WARNING
            );
        } else {
        ...
        if (is_object($lexer)) {
            ...
            switch ($lexer) {
                case 'DOMLex':
                    $inst = new WPLab_Amazon_HTMLPurifier_Lexer_DOMLex();
                    break;
                case 'DirectLex':
                    $inst = new WPLab_Amazon_HTMLPurifier_Lexer_DirectLex();
                    break;
                case 'PH5P':
                    $inst = new WPLab_Amazon_HTMLPurifier_Lexer_PH5P();
                    break;
                default:
        ...
        if (!$inst) {
            throw new WPLab_Amazon_HTMLPurifier_Exception('No lexer was instantiated');
        }
    ...
    {
        $this->_entity_parser = new WPLab_Amazon_HTMLPurifier_EntityParser();
    }
     ...
     * @return WPLab_Amazon_HTMLPurifier_Token[] array representation of HTML.
     */
    ...
    protected static function escapeCDATA($string)
    {
        return preg_replace_callback(
            '/<!\[CDATA\[(.+?)\]\]>/s',
            array('WPLab_Amazon_HTMLPurifier_Lexer', 'CDATACallback'),
            $string
        );
    }
    ...
    public function normalize($html, $config, $context)
    {
        ...
        $html = WPLab_Amazon_HTMLPurifier_Encoder::cleanUTF8($html);
