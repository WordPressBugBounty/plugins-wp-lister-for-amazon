...
class WPLab_Amazon_HTMLPurifier_HTMLModuleManager
{

    /**
     * @type WPLab_Amazon_HTMLPurifier_DoctypeRegistry
     */
    public $doctypes;
    ...
    /**
     * @type WPLab_Amazon_HTMLPurifier_AttrTypes
     */
    public $attrTypes;
     ...
     * @type WPLab_Amazon_HTMLPurifier_HTMLModule[]
     */
    public $modules = array();

    /**
     * Array of recognized WPLab_Amazon_HTMLPurifier_HTMLModule instances,
    ...
    /**
     * @type WPLab_Amazon_HTMLPurifier_ContentSets
     */
    public $contentSets;

    /**
     * @type WPLab_Amazon_HTMLPurifier_AttrCollections
     */
    ...
    public function __construct()
    {
        ...
        $this->attrTypes = new WPLab_Amazon_HTMLPurifier_AttrTypes();
        $this->doctypes  = new WPLab_Amazon_HTMLPurifier_DoctypeRegistry();
     ...
     *                WPLab_Amazon_HTMLPurifier_HTMLModule prefix, or instance of
     *                subclass of WPLab_Amazon_HTMLPurifier_HTMLModule.
    ...
    public function setup($config)
    {
        ...
        $this->contentSets = new WPLab_Amazon_HTMLPurifier_ContentSets(
            // content set assembly deals with all possible modules,
            // not just ones deemed to be "safe"
            $this->modules
        );
        $this->attrCollections = new WPLab_Amazon_HTMLPurifier_AttrCollections(
            $this->attrTypes,
     ...
     * @return Array of WPLab_Amazon_HTMLPurifier_ElementDef
     */
     ...
     * @return WPLab_Amazon_HTMLPurifier_ElementDef Merged WPLab_Amazon_HTMLPurifier_ElementDef
