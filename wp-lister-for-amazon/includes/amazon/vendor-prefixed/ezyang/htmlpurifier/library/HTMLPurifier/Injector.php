 ...
 * are best described WPLab_Amazon_HTMLPurifier_Strategy_MakeWellFormed->processToken()
 * documentation.
 *
 ...
 */
abstract class WPLab_Amazon_HTMLPurifier_Injector
{
     ...
     * @param WPLab_Amazon_HTMLPurifier_Token $current Current token variable.
    ...
    protected function forwardUntilEndToken(&$i, &$current, &$nesting)
    {
        ...
        if ($current instanceof WPLab_Amazon_HTMLPurifier_Token_Start) {
            $nesting++;
        } elseif ($current instanceof WPLab_Amazon_HTMLPurifier_Token_End) {
            if ($nesting <= 0) {
                return false;
            }
            $nesting--;
     ...
     * @param WPLab_Amazon_HTMLPurifier_Token $token Current token variable.
