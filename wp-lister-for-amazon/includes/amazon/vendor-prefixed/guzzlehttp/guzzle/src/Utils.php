...
use WPLab\Amazon\GuzzleHttp\Exception\InvalidArgumentException;
use WPLab\Amazon\GuzzleHttp\Handler\CurlHandler;
use WPLab\Amazon\GuzzleHttp\Handler\CurlMultiHandler;
use WPLab\Amazon\GuzzleHttp\Handler\Proxy;
use WPLab\Amazon\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
     ...
     *
     * @return callable(\WPLab\Amazon\Psr\Http\Message\RequestInterface, array): \WPLab\Amazon\GuzzleHttp\Promise\PromiseInterface Returns the best handler for the given system.
     *
