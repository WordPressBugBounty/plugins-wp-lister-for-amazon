...
use WPLab\Amazon\ZipStream\Exception\FileNotFoundException;
use WPLab\Amazon\ZipStream\Exception\FileNotReadableException;
use WPLab\Amazon\ZipStream\Exception\OverflowException;
use WPLab\Amazon\ZipStream\Option\File as FileOptions;
use WPLab\Amazon\ZipStream\Option\Method;
use WPLab\Amazon\ZipStream\Option\Version;
...
class File
{
     ...
     *
     * @return void
     * @throws \WPLab\Amazon\ZipStream\Exception\EncodingException
     */
