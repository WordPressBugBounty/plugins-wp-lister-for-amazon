...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Xls;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\Border;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var null|\WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     */
    public function getEscher(): ?\WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher
    {
        return $this->escher;
    }
     ...
     * Set Escher object.
     */
    public function setEscher(?\WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher $escher): void
    {
        $this->escher = $escher;
    }
