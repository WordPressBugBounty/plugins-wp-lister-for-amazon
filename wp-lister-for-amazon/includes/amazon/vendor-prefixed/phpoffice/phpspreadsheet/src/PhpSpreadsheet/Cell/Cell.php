...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Date as SharedDate;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
    ...
    public function getCalculatedValue(bool $resetLog = true)
    {
        if ($this->dataType === DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Calculation\Exception(
