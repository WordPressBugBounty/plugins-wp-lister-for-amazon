...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Cell\DataType;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Cell\Hyperlink;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\DefinedName;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Security\XmlScanner;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\AutoFilter;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Chart;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\ConditionalStyles;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\DataValidations;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Hyperlinks;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\PageSetup;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SheetViewOptions;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SheetViews;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Styles;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Theme;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx\WorkbookView;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\ReferenceHelper;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\RichText\RichText;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Settings;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Date;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Drawing;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\File;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Font;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\StringHelper;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Spreadsheet;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\Color;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\Font as StyleFont;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\NumberFormat;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\Style;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\HeaderFooterDrawing;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if (isset($shape['style'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (isset($drowingImages[$fillImageRelId])) {
                                                    $objDrawing = new \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\WPLab\Amazon\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void
    {
