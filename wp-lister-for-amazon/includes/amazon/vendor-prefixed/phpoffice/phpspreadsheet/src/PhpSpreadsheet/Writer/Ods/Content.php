...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Row;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\RowCellIterator;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Exception;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Ods;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Style;
...
//                $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
    ...
    private function writeCells(XMLWriter $objWriter, RowCellIterator $cells): void
    {
        ...
        foreach ($cells as $cell) {
            /** @var \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Cell\Cell $cell */
