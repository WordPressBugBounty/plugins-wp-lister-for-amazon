...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Properties;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Chart $chart, $calculateCellValues = true)
    {
        // Create XML writer
        $objWriter = null;
