...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Axis;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\ChartColor;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\DataSeries;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\GridLines;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Layout;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Legend;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\PlotArea;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Properties as ChartProperties;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Title;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\TrendLine;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Chart
     */
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
