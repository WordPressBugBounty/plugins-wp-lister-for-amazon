...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\RichText\Run;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Drawing as SharedDrawing;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\OLE;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\File;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\Root;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Spreadsheet;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\Drawing;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Worksheet\MemoryDrawing;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet;
    ...
    private function buildWorksheetEschers(): void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \WPLab\Amazon\PhpOffice\PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
