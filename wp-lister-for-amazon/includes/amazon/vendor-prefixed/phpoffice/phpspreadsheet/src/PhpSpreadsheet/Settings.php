...
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Renderer\IRenderer;
use WPLab\Amazon\PhpOffice\PhpSpreadsheet\Collection\Memory;
use WPLab\Amazon\Psr\Http\Client\ClientInterface;
use WPLab\Amazon\Psr\Http\Message\RequestFactoryInterface;
use WPLab\Amazon\Psr\SimpleCache\CacheInterface;
use ReflectionClass;
...
class Settings
{
     ...
     * eg: WPLab\Amazon\PhpOffice\PhpSpreadsheet\Chart\Renderer\JpGraph.
     *
     * @var string
     */
